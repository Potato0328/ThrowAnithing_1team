...
namespace MKH
{
    ...
    public class ShoesData : Item
    {
        public override Item Create()
        {
            ...
            // Rare : 2
            int rate = (int)Rate;
            var csv = CsvManager.Instance.shoes;
            ...
            // 주스텟
            item.mEffect.Speed = Mathf.Round(Random.Range(min, speed) * 100f) / 100f;
            // 설명
            item.Name = csv.GetData($"{rate}", "이름");
            item.Description = $"이동속도 + {item.mEffect.Speed * 100f}";
